	...
	<form action="/uploadProc" method="POST" enctype="multipart/form-data">
		...
		<div class="card">
			...
			<div class="card-body pb-0">
				<table class="table table-borderless pb-0">
					<tbody>
						<tr>
							<td colspan="1" class="text-right">종류선택</td>
		...
		<div class="card">
			<div class="card-header">
				<span class="text-center">위치 정보</span> 
				...
				<table class="table table-borderless">
					<tbody>
						...
						<tr class="text-center">
							...
							<input type="radio" style="display: none;" name="moveDay" value="즉시입주" id="option1" autocomplete="off">즉시입주
							</label> 
							<label for ="option25" class="btn btn-outline-secondary btn-small"> 
							<input type="radio" style="display: none;" name="moveDay" value="날짜협의" id="option2" autocomplete="off">날짜협의
							</label> 
							<label for ="option26" class="btn btn-outline-secondary btn-small"> 
							<input type="radio" style="display: none;" name="moveDay" value="날짜선택" id="option3" autocomplete="off">날짜선택
							</label></div>
							</td>
						</tr>
					</tbody>
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<input type="radio" style="display: none;" name="parking" value="N" id="option1" autocomplete="off">불가능
							</label> 
							<label for ="option28" class="btn btn-outline-secondary btn-small"> 
							<input type="radio" style="display: none;" name="parking" value="P" id="option2" autocomplete="off">가능
							</label></div></td>
							...
							<input type="radio" style="display: none;" name="elevator" value="N" id="option1" autocomplete="off">없음
							</label> 
							<label for ="option30" class="btn btn-outline-secondary btn-small"> 
							<input type="radio" style="display: none;" name="elevator" value="P" id="option2" autocomplete="off">있음
							</label></div></td>
						</tr>
						...
						<tr>
							...
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op1" id="option1" autocomplete="off">에어컨
							</label>
						
							<label for ="option32" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op2" id="option2" autocomplete="off">세탁기
							</label>
							
							<label for ="option33" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op3" id="option3" autocomplete="off">옷장
							</label>
							
							<label for ="option34" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op4" id="option4" autocomplete="off">냉장고
							</label>
							
							<label for ="option35" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op5" id="option5" autocomplete="off">전자도어락
							</label>
						
							<label for ="option36" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op6" id="option6" autocomplete="off">가스레인지
							</label>
							
							<label for ="option37" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op7" id="option7" autocomplete="off">비데
							</label>
							
							<label for ="option38" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op8" id="option8" autocomplete="off">신발장
							</label>
							
							<label for ="option39" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op9" id="option9" autocomplete="off">인덕션
							</label>
						
							<label for ="option40" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op10" id="option10" autocomplete="off">전자레인지
							</label>
						
							<label for ="option41" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op11" id="option11" autocomplete="off">책상
							</label>
						
							<label for ="option42" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op12" id="option12" autocomplete="off">침대
							</label>
						
							<label for ="option43" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op13" id="option13" autocomplete="off">TV
							</label>
						
							<label for ="option44" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op14" id="option14" autocomplete="off">비디오폰
							</label>
						
							<label for ="option45" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op15" id="option15" autocomplete="off">공동현관
							</label>
							
							<label for ="option46" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op16" id="option16" autocomplete="off">경비원
							</label>
							
							<label for ="option47" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op17" id="option17" autocomplete="off">CCTV
							</label>
							
							<label for ="option48" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op18" id="option18" autocomplete="off">방범창
							</label>
						
							<label for ="option49" class="btn btn-outline-info btn-small"> 
							<input type="checkbox" class="form-check-label" style="display: none;" name="optionId" value="op19" id="option19" autocomplete="off">인터폰
							</label></div>	
							</td>
						</tr>	
						<tr>
							...
							<input type="radio" style="display: none;" name="lof" value="N" id="option1" autocomplete="off">불가능
							</label>
							<label for ="option51" class="btn btn-outline-secondary btn-small"> 
							<input type="radio" style="display: none;" name="lof" value="P" id="option2" autocomplete="off">가능
							</label></div> 
							</td>
							<td colspan="2"></td>
							<td colspan="2"></td>
